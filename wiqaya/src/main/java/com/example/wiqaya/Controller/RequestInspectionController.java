...
//    }
    ...
    @GetMapping("/check-request-status/by-req-id/{id}")
    public ResponseEntity<?> checkRequestStatus(@PathVariable Integer id){
        return ResponseEntity.status(200).body(requestInspectionService.checkRequestStatus(id));
    }
