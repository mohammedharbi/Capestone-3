...
public class House {
    ...
    @Pattern(regexp = "^(un_checked|checked|completed)$", message = "Status must be one of the following: un_checked, pending_inspection, inspected, offers_pending, offer_accepted, or completed")
